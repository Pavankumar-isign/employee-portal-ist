...
@Component({
  selector: 'app-sorting-filtering-mahesh',
  templateUrl: './sorting-filtering-mahesh.component.html',
  styleUrl: './sorting-filtering-mahesh.component.scss'
})
export class SortingFilteringMaheshComponent {
 ...
 public ngOnInit() : void {
  const url : string = 'assets/data/data-mahesh.json';
...
images = [
'https://wallpaperaccess.com/full/1448067.jpg',
'https://th.bing.com/th/id/OIP.zgce1WOhSUwy-Uhmdvl3TgHaEK?rs=1&pid=ImgDetMain',
