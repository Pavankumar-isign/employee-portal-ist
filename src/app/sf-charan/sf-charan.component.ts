...
@Component({
  selector: 'app-sf-charan',
  templateUrl: './sf-charan.component.html',
  styleUrl: './sf-charan.component.scss'
})
export class SfCharanComponent implements OnInit {
  userInfo: Product[] = [];
  ...
  ngOnInit(): void {
    const url: string = '/assets/data/data-charan.json';
